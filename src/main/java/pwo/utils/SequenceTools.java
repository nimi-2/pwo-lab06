...
return getTerms((SequenceGenerator) sg, from, to, "\n");
}
...
writer.write(getTermsAsColumn((SequenceGenerator) sg, from, to));
} catch (IOException ex) { return false; }
return true;
}

    private static class SequenceGenerato {

        public SequenceGenerato() {
        }
    }
}